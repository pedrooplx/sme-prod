...
{
    #region MetodosParaUsarAtributoNoServerSide
    //Tratamento de mensagem para o server-side
    ...
    #region MetodosParaUsarAtributoNoClientSide
    //Tratamento de mensagem para o client-side
    ...
    //provider para o MoedaAttributeAdapter
    public class MoedaValidationAttribuiteAdapterProvider : IValidationAttributeAdapterProvider
    {
